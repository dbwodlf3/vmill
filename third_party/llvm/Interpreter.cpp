//
 ...
 static struct RegisterInterp {
   RegisterInterp() { VmillInterpreter::Register(); }
 } InterpRegistrator;
 ...
 ///
 ExecutionEngine *VmillInterpreter::create(std::unique_ptr<Module> M,
                                      std::string *ErrStr) {
   ...
   return new VmillInterpreter(std::move(M));
 }
 ...
 void VmillInterpreter::runAtExitHandlers () {
 ...
 ///
 GenericValue VmillInterpreter::runFunction(Function *F,
